...
const FOLDERS: FolderConfig[] = [
  ...
  },
  {
    ...
    description: "Loan agreements & NOCs",
  },
  {
    id: "property",
    label: "Property",
    ...
    <div className="flex flex-col min-h-screen relative">
      ...
      <div className="relative z-10 flex flex-col min-h-screen p-6">
        ...
        <div className="flex items-center gap-3 pt-8 mb-6">
          <button
            onClick={() =>
              activeFolder ? setActiveFolder(null) : router.push("/rajya")
            }
          ...
          <div>
            ...
            <p className="text-xs text-white/35 mt-0.5">
              ...
              : `${totalFiles} file${totalFiles !== 1 ? "s" : ""} â€¢ Stored locally`
              }
            </p>
          </div>
        </div>
        ...
        <div className="mt-4">
          ...
          <VideoTutorialPlaceholder
            youtubeId="qvk4GawSxgE"
            label="How to organize financial documents digitally"
          />
        </div>
        ...
        {!activeFolder ?
          ...
          <>
            <PageGuide
              ...
              description="Upload and organize important documents â€” certificates, policies, property deeds, and more. All files stay on your device. Cloud backup is optional."
              actions={[
                { emoji: "ðŸ“", label: "Organize" },
                { emoji: "ðŸ“¤", label: "Upload" },
                { emoji: "ðŸ”’", label: "Local storage" },
              ]}
            />
            <div className="h-4" />
