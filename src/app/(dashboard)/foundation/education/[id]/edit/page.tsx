  ...
  if (!record) {
    return (
      <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center text-white">
        ...
        <button onClick={() => router.back()} className="text-amber-400 mt-4">
          Go Back
        </button>
      </div>
    );
    ...
    <div className="flex flex-col min-h-screen p-6 pb-24 relative bg-slate-950">
      <header className="flex items-center gap-4 pt-8 mb-8 relative z-10">
        ...
        <div>
          ...
          <p className="text-[10px] text-[var(--color-rajya-accent)]/60 uppercase tracking-[0.2em] font-semibold">
            {record.degree}
          </p>
        </div>
      </header>
      ...
      <div className="flex-1 space-y-6 max-w-md mx-auto w-full relative z-10">
        ...
        <div className="space-y-4 pt-4 border-t border-white/10">
          <div className="flex items-center justify-between">
            <label className="text-[10px] font-bold text-[var(--color-rajya-muted)] uppercase tracking-[0.15em]">
              ...
              {certificateId ?
                <div className="p-4 bg-emerald-500/10 border border-emerald-500/30 rounded-xl flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="text-xs text-white/40 hover:text-white shrink-0 ml-4"
                  >
                    Remove
                  </button>
                </div>
          ...
          : <div className="grid grid-cols-2 gap-3 max-h-48 overflow-y-auto pr-1 custom-scrollbar">
              {existingFiles.map((file) => (
                ...
                >
                  ...
                  <span className="text-[10px] text-[var(--color-rajya-muted)]">
