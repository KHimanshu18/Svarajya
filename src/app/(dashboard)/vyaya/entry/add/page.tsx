                    ...
                    {showInsightStrip && top2.length >= 2 && (
                        <div className="bg-[var(--color-rajya-accent)]/10 border border-[var(--color-rajya-accent)]/20 rounded-xl p-3 mt-4 w-full max-w-sm">
                            <p className="text-xs text-[var(--color-rajya-text)]">
                                ðŸ“Š Pattern detected: <strong>{top2[0].name} + {top2[1].name}</strong> = {top2[0].percentage + top2[1].percentage}% of spends.
                            </p>
        ...
        <div className="flex flex-col min-h-screen p-6 pb-24 relative">
            ...
            <div className="relative z-10">
                ...
                <div className="bg-[var(--color-rajya-accent)]/8 border border-[var(--color-rajya-accent)]/20 rounded-xl p-3 mb-4">
                    <p className="text-xs text-[var(--color-rajya-muted)]">ðŸ’¡ <strong className="text-[var(--color-rajya-text)]">Real clarity</strong> begins when the drain is measured.</p>
                </div>
                ...
                {/* â€”â€”â€” Optional Section (collapsed) â€”â€”â€” */}
                ...
                {/* Matka leak animation (mini â€” shows single leak, not permanent holes) */}
