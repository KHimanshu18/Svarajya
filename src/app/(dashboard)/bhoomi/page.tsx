  ...
  return (
    <div className="flex flex-col min-h-screen p-6 pb-24 relative bg-gradient-to-b from-slate-950 via-[#0a1628] to-slate-950">
      <header className="pt-8 mb-8 flex items-center gap-3">
        ...
        <div>
          <h1 className="text-lg font-semibold text-white">Bhoomi (Real Estate)</h1>
          <p className="text-xs text-white/35">The land on which your kingdom stands.</p>
        </div>
      </header>
      ...
      <div className="flex-1 flex flex-col items-center justify-center text-center p-6">
        ...
        <h2 className="text-xl font-bold text-white mb-2">Acquiring Land</h2>
        <p className="text-sm text-white/40 max-w-xs mb-8">
          The property management module is currently being architected. Soon you'll be able to manage your physical assets and their yields here.
        </p>
