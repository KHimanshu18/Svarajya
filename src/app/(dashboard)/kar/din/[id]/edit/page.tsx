  ...
  return (
    <div className="min-h-screen bg-slate-950 p-6">
      <div className="max-w-2xl mx-auto bg-slate-900/80 rounded-2xl p-6">
        ...
        <p className="text-sm text-white/60 mt-1">Update the existing DIN record with the latest data.</p>
        ...
        <div className="grid gap-3 mt-6">
          <div>
            ...
            />
            {showErrors && errors.dinNumber && <p className="text-xs text-rose-400 mt-1">{errors.dinNumber}</p>}
          </div>
          ...
          <div>
            ...
            />
            {showErrors && errors.companyName && <p className="text-xs text-rose-400 mt-1">{errors.companyName}</p>}
          </div>
          ...
          <div>
            ...
            />
            {showErrors && errors.issueDate && <p className="text-xs text-rose-400 mt-1">{errors.issueDate}</p>}
          </div>
          ...
          <div>
            ...
            />
            {showErrors && errors.expiryDate && <p className="text-xs text-rose-400 mt-1">{errors.expiryDate}</p>}
          </div>
          ...
          <div>
            ...
            {showErrors && errors.dinKycStatus && <p className="text-xs text-rose-400 mt-1">{errors.dinKycStatus}</p>}
          </div>
          ...
          <div>
            ...
            />
            {showErrors && errors.dscExpiryDate && <p className="text-xs text-rose-400 mt-1">{errors.dscExpiryDate}</p>}
          </div>
          ...
          <div>
            ...
            {showErrors && errors.mcaFilingStatus && <p className="text-xs text-rose-400 mt-1">{errors.mcaFilingStatus}</p>}
          </div>
          ...
          <div>
            ...
            />
            {showErrors && errors.directorSince && <p className="text-xs text-rose-400 mt-1">{errors.directorSince}</p>}
          </div>
