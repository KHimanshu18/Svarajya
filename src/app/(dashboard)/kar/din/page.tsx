  ...
  async function save() {
    try {
      const res = await fetch(
        editing ? `/api/din/records/${editing.id}` : "/api/din/records",
        {
      ...
      <div className="max-w-4xl mx-auto">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-white/60">
                Manage director identification numbers and expiries.
              </p>
            </div>
          </div>
          <div>
            ...
            >
              <Plus className="w-4 h-4" /> Add DIN Record
            </button>
          </div>
        </div>
        ...
        : records.length === 0 ?
          <div className="rounded-2xl p-6 bg-white/5 text-white/60">
            No DIN records added yet
          </div>
        : <div className="grid gap-4">
            {records.map((r) => {
              const days = daysUntil(r.expiryDate);
              const badge =
                days <= 30 ? "bg-rose-500 text-white"
                : days <= 90 ? "bg-amber-400 text-black"
                ...
                >
                  ...
                  <div className="flex flex-col items-end gap-2">
                    ...
                    <div className="flex gap-2">
                      <button
                        onClick={() => router.push(`/kar/din/${r.id}/edit`)}
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-6">
            <div className="w-full max-w-sm bg-slate-900/95 rounded-2xl p-6">
              ...
              <p className="text-sm text-white/70 mb-6">
                Are you sure you want to delete this DIN record? This action
                cannot be undone.
              </p>
