...
export default function NewItrPage() {
  ...
  const errors = useMemo(() => {
    ...
    return fieldErrors;
  }, [form.assessmentYear, form.financialYear, form.filingStatus, form.itrType, form.filingDate, form.taxPayable, form.taxPaid, form.acknowledgementNumber]);
  ...
  async function save() {
    ...
    setSaving(true);
    try {
      const res = await fetch('/api/tax/records', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(form) });
