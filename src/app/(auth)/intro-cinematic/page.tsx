    ...
    >
      ...
      <div className="absolute top-0 left-0 w-full p-6 flex justify-between items-center z-50">
        ...
        <button
          ...
          className="text-white/40 text-xs uppercase tracking-widest font-semibold hover:text-white/70 transition-colors"
        >
          Skip
        </button>
      </div>
            ...
            >
              ...
              >
                <p className="text-amber-200/60 text-sm italic">
                  वहीं से राज्य की समृद्धि संचालित होती थी.
                </p>
                <p className="text-white/40 text-[11px] uppercase tracking-widest leading-relaxed px-4">
                  From there, the prosperity of the kingdom was governed.
                </p>
              </motion.div>
            </motion.div>
          )}
            ...
            >
              ...
              >
                ...
                <p className="text-white/70 text-sm font-medium tracking-wide mb-8">
                  Today we earn wealth…
                  <br />
                  but we no longer have a treasury.
                </p>
            ...
            >
              ...
              >
                <div className="w-20 h-20 rounded-2xl bg-amber-400/10 border border-amber-400/40 flex items-center justify-center shadow-[0_0_50px_rgba(251,191,36,0.3)] mx-auto mb-6">
                  <span className="text-4xl text-amber-400 drop-shadow-lg">
                    ⚖️
                  </span>
                </div>
                <h2 className="font-display text-2xl text-amber-400 mb-1">
                  अब आपका अपना राजकोष.
                </h2>
